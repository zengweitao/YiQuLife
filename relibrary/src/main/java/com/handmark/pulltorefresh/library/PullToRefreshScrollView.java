...
public class PullToRefreshScrollView extends PullToRefreshBase<ScrollView> {
	...
	protected ScrollView createRefreshableView(Context context,
		...
		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
			scrollView = new ObservableInternalScrollViewSDK9(context, attrs);
		} else {
	...
	class ObservableInternalScrollViewSDK9 extends ScrollView {

		// private ScrollViewListener scrollViewListener = null;
		//

		public ObservableInternalScrollViewSDK9(Context context) {
			super(context);
		}

		public ObservableInternalScrollViewSDK9(Context context, AttributeSet attrs,
				int defStyle) {
			super(context, attrs, defStyle);
		}
