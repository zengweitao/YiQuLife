...
import com.quanmai.yiqu.common.photopicker.adapters.FloderAdapter;
import com.quanmai.yiqu.common.photopicker.adapters.PhotoAdapter;
import com.quanmai.yiqu.common.photopicker.beans.Photo;
import com.quanmai.yiqu.common.photopicker.beans.PhotoFloder;
import com.quanmai.yiqu.common.photopicker.utils.LogUtils;
import com.quanmai.yiqu.common.photopicker.utils.OtherUtils;
import com.quanmai.yiqu.common.photopicker.utils.PhotoUtils;
...
public class PhotoPickerActivity extends Activity implements PhotoAdapter.PhotoClickCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            manager.setStatusBarTintColor(Color.parseColor("#2E2E2E"));
        }
    ...
    private void getPhotosSuccess() {
        ...
        if (getIntent().hasExtra(SELECTED_PHOTOS)){
            ArrayList<String> selected_photos = getIntent().getStringArrayListExtra(SELECTED_PHOTOS);
            if (selected_photos!=null&&selected_photos.size()>0){
                mPhotoAdapter.setmSelectedPhotos(selected_photos);
            }
        }
