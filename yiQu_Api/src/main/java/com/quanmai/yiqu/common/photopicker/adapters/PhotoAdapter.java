package com.quanmai.yiqu.common.photopicker.adapters;
...
public class PhotoAdapter extends BaseAdapter {
    ...
    public void setmSelectedPhotos(List<String> data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(getItemViewType(position) == TYPE_CAMERA) {
            ...
            BaseImageLoader.getInstance().display(photo.getPath(), holder.photoImageView,
                    mWidth, mWidth);
        }
        return convertView;
    }
