...
final class CameraConfigurationManager {
	...
	void initFromCameraParameters(Camera camera) {
		...
		// display.getHeight());
		Log.e("mark","屏幕W："+dm.widthPixels);
		Log.e("mark","屏幕H："+dm.heightPixels);
...
//		Log.e(TAG, "camera setPreviewSize: " + cameraResolution.x + ","
//				+ cameraResolution.y);
//		setFlash(parameters);
//		setZoom(parameters);
...
//	}
	...
	private static Point getCameraResolution(Camera.Parameters parameters,
		...
		if (previewSizeValueString != null) {
			Utils.E("camera preview-size-values: " + previewSizeValueString);
			cameraResolution = findBestPreviewSizeValue(previewSizeValueString,
					screenResolution);
			Utils.E("camera best preview-size-values: " + cameraResolution.x
					+ "," + cameraResolution.y);
		}
