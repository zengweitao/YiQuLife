...
package com.quanmai.yiqu.common.zxing.camera;
...
public final class CameraManager {
  ...
  public static void init(Context context) {
    ...
    MAX_FRAME_HEIGHT =Dp2Px(context,280) ;
  }
...
//        y = dm.widthPixels;
//      }
//      int width = cameraResolution.y * 2 / 3;
//
//      int height = width;
//
//      int leftOffset = (y - width) / 2;
//      int topOffset = (x-height)/2;
...
//    return framingRect;
    ...
    if (framingRect == null) {
      ...
      Log.e("mark",MIN_FRAME_WIDTH+"---"+MAX_FRAME_WIDTH+"---"+MIN_FRAME_HEIGHT+"---"+MAX_FRAME_HEIGHT);
      Log.e("mark","width: "+width+"---height: "+height);
  ...
  public Rect getFramingRectInPreview() {
    if (framingRectInPreview == null) {
      ...
      Point screenResolution = configManager.getScreenResolution();
//      Log.e("q", "cameraResolution.y ="+cameraResolution.y );
//      Log.e("q", "cameraResolution.x ="+cameraResolution.x );
//      Log.e("q", "screenResolution.y ="+screenResolution.y );
//      Log.e("q", "screenResolution.x ="+screenResolution.x );
