...
public class ShareCopyActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
			...
			tintManager.setStatusBarTintColor(Color.argb(0, 0, 0, 0));
			tintManager.setTintColor(Color.argb(0, 0, 0, 0));
		}
	...
	public void getShareDialog(final String url, final String content, final String img,final String title) {
			mShareDialog = new ShareDialog(ShareCopyActivity.this, new onShareListener() {
