...
/**
 * Created by Kin on 2017/2/28.
 */
public class ScanGivingActivity extends MipcaActivityCapture  {
    ...
    private void init() {
        ...
        ((TextView) findViewById(R.id.tv_title)).setText("扫码赠送");
...
//        });
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case PARSE_BARCODE_FAIL:
                    Utils.showCustomToast(ScanGivingActivity.this, (String) msg.obj);
                    break;
            }
        }
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case REQUEST_CODE:
                    ...
                    mProgress = new ProgressDialog(ScanGivingActivity.this);
    ...
    private void onResultHandler(Result result) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            Utils.showCustomToast(ScanGivingActivity.this, "扫描失败！");
            return;
        }
        if (resultString.trim().length()!=64){
            handler.sendEmptyMessageAtTime(R.id.restart_preview,2000);
    ...
    private void submit(String inputType, String result) {
        ...
        intent.setClass(mContext, GivingConfirmActivity.class);
    ...
    private void initDialog() {
        mDialog = DialogUtil.getPopupConfirmEditTextDialog(mContext, "手动输入", "确定", "取消", "请输入用户的手机号码", new DialogUtil.OnDialogClickListener() {
            @Override
