...
public class CustomFlowLayout extends ViewGroup {
    ...
    //保持常亮模式
    public static final int FLOW_TAG_KEEP_BRIGHT = 3;
...
//              new MarginLayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));//这个构造方法所然能使用但是编译器会报错
            ...
            if (mAdapter instanceof OnInitSelectedPosition) {
                ...
                }else if (mTagCheckMode == FLOW_TAG_KEEP_BRIGHT){
                    mCheckedTagArray.put(i, true);
                    childView.setSelected(true);
                }
            }
                ...
                public void onClick(View v) {
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {
                        if (mOnTagClickListener != null) {
                            mOnTagClickListener.onItemClick(CustomFlowLayout.this, childView, j);
                        }
                        ...
                        if (mCheckedTagArray.get(j)) {
                            ...
                            if (mOnTagSelectListener != null) {
                                mOnTagSelectListener.onItemSelect(CustomFlowLayout.this, new ArrayList<Integer>());
                            }
                            return;
                        }
                        ...
                        if (mOnTagSelectListener != null) {
                            mOnTagSelectListener.onItemSelect(CustomFlowLayout.this, Arrays.asList(j));
                        }
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_MULTI) {
                        list.clear();
                        if (mCheckedTagArray.get(j)) {
                        ...
                        if (mOnTagSelectListener != null) {
                            ...
                            mOnTagSelectListener.onItemSelect(CustomFlowLayout.this, list);
                        }
                    }
                }
            });
    ...
    public interface OnTagClickListener {
        void onItemClick(CustomFlowLayout parent, View view, int position);
    }

    public interface OnTagSelectListener {
        void onItemSelect(CustomFlowLayout parent, List<Integer> selectedList);
    }
}
