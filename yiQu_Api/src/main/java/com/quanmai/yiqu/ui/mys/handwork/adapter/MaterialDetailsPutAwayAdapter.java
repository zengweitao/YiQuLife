...
public class MaterialDetailsPutAwayAdapter extends BaseAdapter {
    Context mContext;
    CommonList<MaterialOrUserDetailsInfo.InventoryListBean> mListI;

    public MaterialDetailsPutAwayAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.item_material_putaway, null);
        ...
        if (mListI!=null&&mListI.size()>0) {
            ...
            viewHolder.tvName.setText(info.getRecipient());
            viewHolder.tvPhone.setText(info.getRecipientmtel());
