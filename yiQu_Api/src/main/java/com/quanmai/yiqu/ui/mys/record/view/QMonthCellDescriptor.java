...
/** Describes the state of a particular date cell in a {@link QMonthView}. */
public class QMonthCellDescriptor {
	...
	public QMonthCellDescriptor(Date date, boolean currentMonth,
			boolean selectable, boolean selected, boolean today,
			boolean highlighted, int value, String strMark,
